...
exports.map = src_1.map;
exports.mapping = src_1.mapping;
...
function mapping(options) {
    return function (target, name) {
        ...
        target[constants_1.PROPERTIES_KEY] = target[constants_1.PROPERTIES_KEY] || {};
        target[constants_1.PROPERTIES_KEY][property.source] = target[constants_1.PROPERTIES_KEY][property.source] || [];
        utils_1.pushByOrder(target[constants_1.PROPERTIES_KEY][property.source], property, function (item) { return item.order; });
    };
}
exports.mapping = mapping;

},{"./constants":5,"./property":8,"./utils":9}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
Object.defineProperty(exports, "__esModule", { value: true });
var constants_1 = require("./constants");
var SYSTEM_TYPES = [String, Boolean, Number, Date];
var SYSTEM_CONVERTERS = [
    function (value) { return value && String(value); },
    function (value) { return Boolean(value); },
    function (value) { return Number(value); },
    function (value) { return value && new Date(value); }
];
function getConverter(type) {
    if (typeof type === 'function') {
        if (constants_1.PROPERTIES_KEY in type.prototype) {
            return function (value, _src, _dest, options) { return map(value, type, options); };
        }
        else {
            var index = SYSTEM_TYPES.indexOf(type);
            if (~index) {
...
function map(src, constuctor, options) {
    ...
    properties[sourceName].forEach(function (property) {
        var _a, _b;
        var result;
        try {
...
},{"./annotation":4,"./converter":6}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var converter_1 = require("./converter");
var constants_1 = require("./constants");
...
},{"./constants":5,"./converter":6,"./utils":9}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var Person = (function () {
    ...
    __decorate([
        index_1.mapping({ path: 'address1', type: [Address] }),
        __metadata("design:type", Array)
    ], Person.prototype, "address1", void 0);
    __decorate([
        index_1.mapping({ type: [Date] }),
        __metadata("design:type", Object)
    ], Person.prototype, "dates", void 0);
    return Person;
}());
var result = index_1.map(data_source_1.default, Person);
if (result) {
    console.assert(Array.isArray(result.dates), '数组转换失败');
    console.assert(result.address1[0] instanceof Address, '数组对像转换失败');
}

},{"../index":1,"./data-source":13,"reflect-metadata":3}],11:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var Person = (function () {
    ...
    __decorate([
        index_1.mapping({ path: 'address1[0].city' }),
        __metadata("design:type", String)
    ], Person.prototype, "cityName", void 0);
    __decorate([
        index_1.mapping(function (_value, src, dest) {
            return "I'm " + src.name + " and i come from " + dest.cityName;
        }),
        __metadata("design:type", String)
    ], Person.prototype, "intro", void 0);
    __decorate([
        index_1.mapping(function () { throw new Error('cast error'); }),
        __metadata("design:type", String)
    ], Person.prototype, "error", void 0);
    return Person;
}());
var result = index_1.map(data_source_1.default, Person);
if (result) {
...
},{"../index":1,"./data-source":13,"reflect-metadata":3}],12:[function(require,module,exports){
"use strict";
...
var result = index_1.map(data_source_1.default, Person);
if (result) {
    console.assert(result.name === data_source_1.default.name, '普通属性获取失败');
    console.assert(result.address && result.address instanceof Address, '自定义对象转换失败');
}

},{"../index":1,"./data-source":13,"reflect-metadata":3}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = {
    name: 'fisher',
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
require("./no-reflect-metadata");
require("./reflect-metadata");
require("./converter");
require("./pull-data");
require("./custom-class");
require("./array");
require("./multi-data-source");
require("./order");

},{"./array":10,"./converter":11,"./custom-class":12,"./multi-data-source":15,"./no-reflect-metadata":16,"./order":17,"./pull-data":18,"./reflect-metadata":19}],15:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var Person = (function () {
    ...
    __decorate([
        index_1.mapping({ type: String, source: 'other', path: 'person.lastname' }),
        index_1.mapping({ type: String, default: 'fisher' }),
        __metadata("design:type", String)
...
var result = index_1.map(data_source_1.default, Person);
var result1 = index_1.map(dataSource1, Person, { source: 'other' });
if (result && result1) {
    console.assert(result.name === data_source_1.default.name && result1.name === dataSource1.person.lastname, '多个数据源属性获取失败');
}

},{"../index":1,"./data-source":13}],16:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var Person = (function () {
    ...
    __decorate([
        index_1.mapping({ type: String }),
        __metadata("design:type", String)
    ], Person.prototype, "name", void 0);
    __decorate([
        index_1.mapping({ type: Boolean }),
        __metadata("design:type", Boolean)
    ], Person.prototype, "gender", void 0);
    __decorate([
        index_1.mapping({ type: Number }),
        __metadata("design:type", Number)
    ], Person.prototype, "age", void 0);
    __decorate([
        index_1.mapping({ path: 'src.number', type: Number }),
        __metadata("design:type", Number)
    ], Person.prototype, "num", void 0);
    return Person;
}());
var result = index_1.map(data_source_1.default, Person);
if (result) {
    ...
    console.assert(result.num === +data_source_1.default.src.number, '普通类型转换失败');
    console.assert(result.gender === false, '获取不存在的属性不为空');
}

},{"../index":1,"./data-source":13}],17:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var Person = (function () {
    ...
    __decorate([
        index_1.mapping({ convert: function (_src, dest) { return dest.name; }, order: 1 }),
        __metadata("design:type", String)
...
var result = index_1.map(data_source_1.default, Person);
if (result) {
    console.assert(result.fullName === data_source_1.default.name, '排序属性获取失败');
}

},{"../index":1,"./data-source":13}],18:[function(require,module,exports){
"use strict";
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var Person = (function () {
    ...
    __decorate([
        index_1.mapping({ path: 'src.number' }),
        __metadata("design:type", Number)
    ], Person.prototype, "num", void 0);
    __decorate([
        index_1.mapping({ path: 'address1[0]' }),
        __metadata("design:type", Address)
    ], Person.prototype, "address", void 0);
    return Person;
}());
var result = index_1.map(data_source_1.default, Person);
if (result) {
    console.assert(result.cityName === data_source_1.default.address.city, '属性拉取失败');
    console.assert(typeof result.num === 'number', '拉取基础属性转换失败');
    console.assert(result.address instanceof Address, '拉取自定义类型属性转换失败');
}

},{"../index":1,"./data-source":13,"reflect-metadata":3}],19:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../index":1,"./data-source":13,"reflect-metadata":3}]},{},[14]);
